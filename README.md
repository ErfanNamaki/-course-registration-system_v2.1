# -course-registration-system_v2.1# 🎓 سیستم ثبت‌نام دوره‌های آموزشی به همراه گزارش‌گیری (Python + Tkinter + SQLite)
...
2. نصب کتابخانه‌های مورد نیاز در مسیر پوشه اصلی:
   pip install -r requirements.txt

3. اجرای برنامه:
   course-registration-system_v2.1.exe
